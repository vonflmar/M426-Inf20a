...
Repository](https://github.com/vonflmar/M426-Inf20a.git) offen
...
sind, also z.B. `peterp/M426-Inf20a` statt
`vonflmar/M426-Inf20a`. Dies ist nun ihre persönliche Kopie, und Sie
...
Anschliessend können Sie das Repository folgendermassen klonen:
    ...
    $ git clone https://github.com/vonflmar/M426-Inf20a.git
...
dieses zunächst als sog. _Remote_ hinzufügen:
    ...
    $ git remote add upstream https://github.com/vonflmar/M426-Inf20a.git
